...
| Field | Data |
|-------|------|
| Coverage | Palm Beach, Martin, St. Lucie, Indian River counties; 40+ named municipalities |
| Services | ALTA, Boundary Surveys, Flood Elevation Certificates, Topographic, Construction Layout/Staking, Subdivision Plats, As-Built, Tree & Utility Surveys, Lot Split Surveys |
| Differentiator | Named PSM (Rick Morales); FEMA fluent; 100% satisfaction guarantee; explicit local SEO with county/city landing pages |
| Pricing | Not published; free phone quote |
...
| Field | Data |
|-------|------|
| Coverage | Miami-Dade, Broward, Palm Beach, Martin, St. Lucie counties |
| Services | Purchases & Refinances, Flood Insurance, New Construction, Property Improvements, Docks/Seawall/Mean High Water, Liquor License, Topographic, Boundary Disputes, Platting, Sub-Divisions, Construction Layout |
| Differentiator | Since 1983; 100,000+ surveys completed; 72-hour turnaround; free real estate professional seminars (referral pipeline strategy) |
| Pricing | Not published |
...
| Field | Data |
|-------|------|
| Coverage | Miami, Fort Lauderdale, South Florida, West Palm Beach, Kendall, Brickell, Coral Gables, Cutler Bay, Pinecrest, Hollywood |
| Services | Boundary, Topographic, ALTA, Elevation Certificates, Construction, Stormwater/Drainage Design, Roadway Design, ADA Compliance, plus 10 more engineering services |
| Differentiator | 20+ years; 48-hour turnaround; FSMS + NSPS member; hybrid surveying + civil engineering scope |
| Pricing | Not published |
...
| Field | Data |
|-------|------|
| Coverage | South Florida (HQ: Davie, Broward County) |
| Services | ALTA, As-Built, Aviation, Boundary, Construction, Drone-Based, Engineering, Environmental, Litigation, Topographic, Utility Mapping, Aerial Mapping, Hydrographic, Laser Scanner, Specific Surveys |
| Differentiator | Third-generation firm since 1988; 35+ years; aviation surveys, litigation surveys, hydrographic are specializations |
| Pricing | Not published |
...
| Field | Data |
|-------|------|
| Coverage | Tampa HQ + Sanford, Ft. Pierce, Jacksonville, Fort Myers, Melbourne; Southeast US; 15 states |
| Services | 21 services including ALTA, Boundary, UAV Mapping, 3D Laser Scanning, Mobile LiDAR, Hydrographic, SUE, GIS, LOMA/LOMR, Expert Witness, Oil & Gas Pipeline |
| Differentiator | FAA-approved UAV; TWIC/MICCS badged; OSHA/MSHA certified; government/infrastructure focus |
| Pricing | Not published |
...
| Field | Data |
|-------|------|
| Coverage | Florida statewide (Tampa Bay area focus) |
| Services | Elevation Certificates, Flood Zone Correction, LOMA Processing, Flood Analysis Memos, Flood Insurance Placement |
| Differentiator | Processes FEMA LOMA/LOMR on client's behalf to remove properties from flood zones; complimentary flood zone reviews; bilingual |
| Pricing | Not published; free initial review |
...
## 5. Competitor Names & Domains (for `flag_triggers.py`)

### Competitor Names (as they may appear in survey orders or client emails)

```
Apex Surveying & Mapping, Apex Surveying, ApexSurvey
GT Surveys, GT Surveyors
Land Surveying Palm Beach, Florida Builders Engineers & Inspectors
Accurate Land Surveyors, Accurate Land Surveyors Inc
Suarez Surveying & Mapping, Suarez Surveying
Stoner & Associates, Stoner Surveyors
SurvTech Solutions, SurvTech
No Flood Florida, National Flood Experts
...
## 6. Never-Auto-Quote Service Candidates

Services from NexGen's 24-service list where auto-quoting carries high risk:
...
**Note:** This is a bootstrap list. Robert/Mark must confirm and expand before Sprint 3. ALTA Table A Survey and Other Services are already in ALWAYS_FLAG_SERVICES and do not need duplication here.

---

## 7. Market Pricing Benchmarks (Florida)
...
| # | Area | Issue | Suggestion |
|---|------|-------|-----------|
| 9 | **Saturday Availability** | GT Surveys opens Saturday. Real estate closings frequently require urgent weekend quotes. | Add Saturday morning hours or a weekend quote request with guaranteed Monday AM response. |
...
## 9. Key Competitive Vulnerability Summary
