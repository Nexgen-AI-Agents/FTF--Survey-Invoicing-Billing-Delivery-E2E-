...
You are still leaerning! You know it. I know it. Don't pretend you are not.
...
- Read dependencies folders to know about the existing dependencies.
- Read Reources folder to understand all the resources we have from the client to create this project (agentic AI).
- Analyze examples from the docs, if existing.
...
- Always Read first claude.md and then memory.md.
